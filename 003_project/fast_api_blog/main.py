...
posts: list[dict] = [
    ...
    },
    {
        "id": 3,
        "author": "Checho Rios",
        "title": "Los datos como motor de la economia",
        "content": "Como los datos pueden transformar el norte de las organizaciones.",
        "date_posted": "Enero 21, 2026",
    },
]
...
def validation_exception_handler(request: Request, exception: RequestValidationError):
    ...
    return templates.TemplateResponse(
        ...
        "error.html",
        {
            ...
            "message": "Invalid reques. Please check your input and try again",
        },
        status_code=status.HTTP_422_UNPROCESSABLE_CONTENT,
    )